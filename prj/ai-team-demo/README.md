...
All tests should show green. To run headlessly with Node 18+:
...
| Branch           | PRs | PR strategy                          |
|------------------|-----|--------------------------------------|
| `exp/small-pr`   | 6   | One narrow concern per PR            |
| `exp/medium-pr`  | 3   | Grouped-by-slice PRs                 |
| `exp/large-pr`   | 2   | Few broad PRs (this branch)          |
